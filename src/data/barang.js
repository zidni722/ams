export const dataBarang = [
    {
        title: "Macbook Pro 2020 MXK32",
        thumb: "/assets/img/Macbook-Pro-2020.jpg",
        os: "macOS adalah sistem operasi yang menjalankan semua yang Anda lakukan di Mac. macOS Catalina menghadirkan aplikasi khusus untuk musik, TV, dan podcast. Pembaruan cerdas untuk aplikasi yang paling sering Anda gunakan. Dan Sidecar, yang memungkinkan Anda menggunakan iPad sebagai layar kedua. Jadi, Anda dapat melakukan berbagai hal biasa jadi luar biasa. ",
        layar: "Layar 13,3 inci (diagonal) dengan lampu latar LED dan teknologi IPS; resolusi 2560 x 1600 pada 227 piksel per inci dengan dukungan untuk jutaan warna",
        prosesor: "Intel Core i5 generasi ke-8 quad-core 1,4 GHz, Turbo Boost hingga 3,9 GHz, dengan eDRAM sebesar 128 MB",
